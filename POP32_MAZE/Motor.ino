...
void TurnLeft() { //เลี้ยวซ้าย
  ...
  delay(200);
//  ConvertADC();
//  while (L < 15) { //ถ้าเจอขาวอยูjวนอ่านค่าสีไไปเรื่อยๆ จนเจอดำ
//    ConvertADC();
//  }
  MotorStop();
}
...
//  ConvertADC();
//  while (R < 15) { //ถ้าเจอขาวอยู่วนอ่านค่าสีไไปเรื่อยๆ จนเจอดำ
//    ConvertADC();
//  }
  MotorStop();
}
...
//  ConvertADC();
//  while (R < 15) { //ถ้่าเจอขาวอยูู่่ วนอ่านค่าสีไไปเรื่อยๆ จนเจอดำ
//    ConvertADC();
//  }
  MotorStop();
}
