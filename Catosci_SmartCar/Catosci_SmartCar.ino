...
//new #include "WS2812B_RGBLED_Controller.h"
...
//new #define STRIP_I2C_ADDRESS  0x20
//new #define STRIP_LEDS_COUNT   10
...
//FWS2812B_Controller strip(STRIP_I2C_ADDRESS, STRIP_LEDS_COUNT, TYPE_GRB);
...
//    String sendString = String(ACTION_ULTRASONIC)+String(INTERVAL_CHAR)+String((distance[1]));
